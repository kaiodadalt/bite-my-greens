...
use App\Domain\ChallengeGroup\Services\DeleteChallengeGroupService;
...
readonly class DeleteChallengeGroupUseCase extends UseCase
{
    public function __construct(
        private DeleteChallengeGroupService $service
    ) {}

    /**
     * @throws DomainAuthorizationException
     */
    public function execute(UserDTO $user_dto, DeleteChallengeGroupDTO $challenge_group_dto): bool
    {
        $user = new UserEntity(
            $user_dto->id,
            $user_dto->name,
